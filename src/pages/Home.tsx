        ...
        <div className="flex flex-col min-h-screen">
            ...
            <section className="py-16 md:py-24 bg-transparent transition-colors duration-300">
                <div className="container mx-auto px-4 text-center max-w-7xl">
                    <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-white border border-slate-200/90 shadow-xs mb-4 rotate-1">
                    ...
                    <h2 className="text-3xl sm:text-5xl md:text-6xl font-black uppercase tracking-tight mb-4 text-slate-900 leading-[1.08]">
                        {t('partners.title')}{' '}
                    ...
                    <p className="text-slate-600 text-sm sm:text-base max-w-xl mx-auto mb-10">
                    ...
                    <div className="flex flex-wrap justify-center gap-3 sm:gap-4 md:gap-5 items-center mb-10 max-w-6xl mx-auto">
                        {[
                            ...
                            <div
                                key={partner.name}
                                className="bg-white border border-slate-200/90 rounded-2xl p-3 sm:p-4 w-[calc(50%-0.5rem)] xs:w-[calc(33.333%-0.75rem)] sm:w-[calc(25%-0.75rem)] lg:w-36 xl:w-40 h-20 sm:h-24 flex items-center justify-center overflow-hidden shadow-xs hover:border-orange-400 hover:shadow-md transition-all duration-200 group"
                            >
                                <img
                                    src={partner.src}
                                    alt={partner.name}
                    ...
                    <Link
                        to="/partenaires"
                        className="inline-flex items-center gap-2 px-6 py-3 rounded-xl bg-white border border-slate-200/90 hover:border-orange-400 hover:bg-orange-50/50 text-slate-800 hover:text-orange-600 font-black text-xs sm:text-sm uppercase tracking-wider transition-all shadow-xs"
                    >
