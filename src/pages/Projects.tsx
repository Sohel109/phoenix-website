    ...
    return (
        <div className="pt-page-safe pb-24 bg-[#FFFBF4] bg-bird-pattern min-h-screen">
            <div className="container mx-auto px-4 max-w-7xl">
                            ...
                            >
                                ...
                                <div className={`relative aspect-video w-full overflow-hidden ${project.id === 'sup-d-om' ? 'bg-white border-b border-[#ECDDFD]/60' : 'bg-slate-900'} flex items-center justify-center`}>
                                    ...
                                    <div className="absolute top-3.5 left-3.5 flex flex-wrap gap-1.5 z-10">
                                        <span className="px-3 py-1 rounded-full text-xs font-school font-bold bg-white/95 backdrop-blur-md text-[#2A082D] shadow-soft border border-slate-200/80">
                                            {project.category}
                                        </span>
                                        {project.isCordee && (
                                    ...
                                    <div className="absolute top-3.5 right-3.5 z-10">
                                        <span className="px-3 py-1 rounded-full text-[11px] font-school font-bold bg-[#2A082D]/85 backdrop-blur-md text-white shadow-soft">
                ...
                <div className="bg-[#ECDDFD]/70 border-2 border-[#6F2B75]/20 rounded-[2.5rem] p-6 sm:p-10 shadow-soft-lg overflow-hidden relative">
                    ...
                    {/* Schedule Table */}
                    <div className="overflow-x-auto bg-white/90 backdrop-blur-sm rounded-2xl border-2 border-[#2A082D]/20 shadow-soft">
                        <table className="w-full text-left text-sm border-collapse min-w-[620px]">
                            <thead>
                                <tr className="border-b-2 border-[#2A082D]/20 bg-[#ECDDFD]/60 text-xs font-school font-bold uppercase tracking-wider text-[#2A082D]">
                                    <th className="py-4 px-5 border-r border-[#2A082D]/15">Projet</th>
                                    <th className="py-4 px-3 text-center border-r border-[#2A082D]/15">Lundi</th>
                                    <th className="py-4 px-3 text-center border-r border-[#2A082D]/15">Mardi</th>
                                    <th className="py-4 px-3 text-center border-r border-[#2A082D]/15">Mercredi</th>
                                    <th className="py-4 px-3 text-center border-r border-[#2A082D]/15">Jeudi</th>
                                    <th className="py-4 px-3 text-center border-r border-[#2A082D]/15">Vendredi</th>
                                ...
                                {weeklySchedule.map((item, idx) => (
                                    <tr key={idx} className="hover:bg-[#ECDDFD]/40 transition-colors">
                                        <td className="py-3.5 px-5 font-school font-bold text-[#2A082D] border-r border-[#2A082D]/15 flex items-center justify-between gap-2">
                                            ...
                                            {item.isCordee && (
                                                <span className="text-[10px] px-2 py-0.5 rounded-full bg-[#6F2B75] text-white font-school font-bold uppercase tracking-wider">
                                                    Cordée
                                                </span>
                                            )}
                                        </td>
                                        <td className="py-3.5 px-3 text-center border-r border-[#2A082D]/15">
                                            {item.monday && <span className="inline-flex items-center justify-center w-7 h-7 rounded-lg bg-white text-[#6F2B75] shadow-sm font-black text-sm select-none border border-[#ECDDFD]">✕</span>}
                                        </td>
                                        <td className="py-3.5 px-3 text-center border-r border-[#2A082D]/15">
                                            {item.tuesday && <span className="inline-flex items-center justify-center w-7 h-7 rounded-lg bg-white text-[#6F2B75] shadow-sm font-black text-sm select-none border border-[#ECDDFD]">✕</span>}
                                        </td>
                                        <td className="py-3.5 px-3 text-center border-r border-[#2A082D]/15">
                                            {item.wednesday && <span className="inline-flex items-center justify-center w-7 h-7 rounded-lg bg-white text-[#6F2B75] shadow-sm font-black text-sm select-none border border-[#ECDDFD]">✕</span>}
                                        </td>
                                        <td className="py-3.5 px-3 text-center border-r border-[#2A082D]/15">
                                            {item.thursday && <span className="inline-flex items-center justify-center w-7 h-7 rounded-lg bg-white text-[#6F2B75] shadow-sm font-black text-sm select-none border border-[#ECDDFD]">✕</span>}
                                        </td>
                                        <td className="py-3.5 px-3 text-center border-r border-[#2A082D]/15">
                                            {item.friday && <span className="inline-flex items-center justify-center w-7 h-7 rounded-lg bg-white text-[#6F2B75] shadow-sm font-black text-sm select-none border border-[#ECDDFD]">✕</span>}
                                        </td>
                                        <td className="py-3.5 px-3 text-center">
                                            {item.saturday && <span className="inline-flex items-center justify-center w-7 h-7 rounded-lg bg-[#6F2B75] text-white shadow-sm font-black text-sm select-none">✕</span>}
                                        </td>
                                    </tr>
                                ))}
                            </tbody>
